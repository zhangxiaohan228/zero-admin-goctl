...
import (
	...
	"github.com/zhangxiaohan228/zero-admin-goctl/api/apigen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/dartgen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/docgen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/format"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/gogen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/javagen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/ktgen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/new"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/tsgen"
	"github.com/zhangxiaohan228/zero-admin-goctl/api/validate"
	"github.com/zhangxiaohan228/zero-admin-goctl/config"
	"github.com/zhangxiaohan228/zero-admin-goctl/internal/cobrax"
	"github.com/zhangxiaohan228/zero-admin-goctl/plugin"
)
