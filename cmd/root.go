...
import (
	_ "embed"
	"fmt"
	"github.com/zhangxiaohan228/zero-admin-goctl/api"
	"github.com/zhangxiaohan228/zero-admin-goctl/bug"
	"github.com/zhangxiaohan228/zero-admin-goctl/config"
	"github.com/zhangxiaohan228/zero-admin-goctl/docker"
	"github.com/zhangxiaohan228/zero-admin-goctl/env"
	"github.com/zhangxiaohan228/zero-admin-goctl/gateway"
	"github.com/zhangxiaohan228/zero-admin-goctl/internal/cobrax"
	"github.com/zhangxiaohan228/zero-admin-goctl/internal/version"
	"github.com/zhangxiaohan228/zero-admin-goctl/kube"
	"github.com/zhangxiaohan228/zero-admin-goctl/migrate"
	"github.com/zhangxiaohan228/zero-admin-goctl/model"
	"github.com/zhangxiaohan228/zero-admin-goctl/quickstart"
	"github.com/zhangxiaohan228/zero-admin-goctl/rpc"
	"github.com/zhangxiaohan228/zero-admin-goctl/tpl"
	"github.com/zhangxiaohan228/zero-admin-goctl/upgrade"
	"os"
	"runtime"
	"strings"
	"text/template"
